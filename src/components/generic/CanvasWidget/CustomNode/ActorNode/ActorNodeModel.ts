...
import { ActorPortModel } from './ActorPortModel';
import { OptionDefinition } from '@cloudscape-design/components/internal/components/option/interfaces';

export interface ActorNodeModelGenerics {
  PORT?: ActorPortModel;
  filterSTRIDE?: string;
  name?: string;
  description?: string;
...
export default class ActorNodeModel extends NodeModel<NodeModelGenerics & ActorNodeModelGenerics> {
  filterSTRIDE: string = 'S,R';
  ...
  constructor(props: ActorNodeModelGenerics = {}) {
    super({
      ...props,
		  type: 'actor',
      selected: true,
	  });
    this.addPort(new ActorPortModel(PortModelAlignment.TOP));
    this.addPort(new ActorPortModel(PortModelAlignment.LEFT));
    this.addPort(new ActorPortModel(PortModelAlignment.BOTTOM));
	  this.addPort(new ActorPortModel(PortModelAlignment.RIGHT));
