...
import { DatastorePortModel } from './DatastorePortModel';
import { OptionDefinition } from '@cloudscape-design/components/internal/components/option/interfaces';

export interface DatastoreNodeModelGenerics {
  PORT?: DatastorePortModel;
  filterSTRIDE?: string;
  name?: string;
  description?: string;
  outOfScope?: boolean;
...
export default class DatastoreNodeModel extends NodeModel<NodeModelGenerics & DatastoreNodeModelGenerics> {
  filterSTRIDE: string = 'T,I,D';
  ...
  constructor(props: DatastoreNodeModelGenerics = {}) {
    super({
      ...props,
		  type: 'datastore',
      selected: true,
	  });
    this.addPort(new DatastorePortModel(PortModelAlignment.TOP));
    this.addPort(new DatastorePortModel(PortModelAlignment.LEFT));
    this.addPort(new DatastorePortModel(PortModelAlignment.BOTTOM));
	  this.addPort(new DatastorePortModel(PortModelAlignment.RIGHT));
