...
export type IOnTrustBoundaryClick = (input: { trustBoundaryId: string }) => void;

export type IOnDragTrustBoundary = (input: { event: MouseEvent; data: DraggableData; id: string }) => void;
